...
from browserMCP.dom.history_tree_processor.view import CoordinateSet, HashedDomElement, ViewportInfo
...
class DOMElementNode(DOMBaseNode):
	...
	def hash(self) -> HashedDomElement:
		from browserMCP.dom.history_tree_processor.service import (
