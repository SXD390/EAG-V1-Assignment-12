...
async def interactive() -> None:
    ...
    # Create a single persistent EnhancedAgentLoop instance with browser support
    loop = EnhancedAgentLoop(
        perception_prompt="prompts/perception_prompt2.txt",  # Use updated perception prompt
        decision_prompt="prompts/decision_prompt.txt",
        summarizer_prompt="prompts/summarizer_prompt.txt",
        browser_prompt="prompts/browser_prompt.txt",  # Add browser prompt
        multi_mcp=multi_mcp,
